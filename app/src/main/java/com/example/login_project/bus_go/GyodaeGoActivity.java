...
public class GyodaeGoActivity extends AppCompatActivity {

    private FirebaseAuth mFirebaseAuth;
    private DatabaseReference mDatabaseRef;
    private Button Gyodae_go1;
    private Button Gyodae_go2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gyodae_go);
        ...
        Gyodae_go1 = findViewById(R.id.btn_GD_go1);
        Gyodae_go2 = findViewById(R.id.btn_GD_go2);
        back_button = findViewById(R.id.back_button10);

        if(friday.equals("1")){
            Gyodae_go2.setEnabled(false);
        }

        Gyodae_go1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(whether == 0){
                    ...
                    for(int i=1; i<=37; i++){
                        ...
                        mDatabaseRef.child(Date).child("교대").child("등교").child("7:30").child(seat).setValue(busSeat);
                    }
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("7:30").child("Exist").setValue("1");
                    Toast.makeText(GyodaeGoActivity.this, "버스추가에 성공했습니다.", Toast.LENGTH_SHORT).show();
                }
                else if(whether == 1){
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("7:30").child("Exist").setValue("0");
                    Toast.makeText(GyodaeGoActivity.this, "버스삭제에 성공했습니다.", Toast.LENGTH_SHORT).show();
                }
                else if(whether == 2){
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("7:30").child("Exist").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (exist.equals("0")) {
                                Toast.makeText(GyodaeGoActivity.this, "존재하지 않는 버스입니다.", Toast.LENGTH_SHORT).show();
                            } else {
                                Intent intent = new Intent(GyodaeGoActivity.this, ReservationActivity.class);
        ...
        Gyodae_go2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(whether == 0){
                    ...
                    for(int i=1; i<=37; i++){
                        String seat = String.valueOf(i);
                        mDatabaseRef.child(Date).child("교대").child("등교").child("8:50").child(seat).setValue(busSeat);
                    }
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                if(whether == 2){
//                    Intent intent1 = new Intent(GyodaeGoActivity.this , ReservationSettingActivity.class);
//                    intent.putExtra("userId", Id);
//                    startActivity(intent1);
//                }
//                else if(whether == 1){
//                    Intent intent2 = new Intent(GyodaeGoActivity.this , BusSearchActivity.class);
