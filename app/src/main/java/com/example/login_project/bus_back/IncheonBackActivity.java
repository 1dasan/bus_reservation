...
public class IncheonBackActivity extends AppCompatActivity {

    private FirebaseAuth mFirebaseAuth;
    private DatabaseReference mDatabaseRef;
    private Button Incheon_back1;
    private Button Incheon_back2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_incheon_back);
        ...
        Incheon_back1 = findViewById(R.id.btn_IC_af1);
        Incheon_back2 = findViewById(R.id.btn_IC_af2);
        back_button = findViewById(R.id.back_button13);

        if(friday.equals("1")){
            Incheon_back1.setEnabled(false);
        }

        Incheon_back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(whether == 0){
                    ...
                    for(int i=1; i<=37; i++){
                        ...
                        mDatabaseRef.child(Date).child("인천,송내").child("하교").child("16:30").child(seat).setValue(busSeat);
                    }
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("16:30").child("Exist").setValue("1");
                    Toast.makeText(IncheonBackActivity.this, "버스추가에 성공했습니다.", Toast.LENGTH_SHORT).show();
                }
                else if(whether == 1){
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("16:30").child("Exist").setValue("0");
                    Toast.makeText(IncheonBackActivity.this, "버스삭제에 성공했습니다.", Toast.LENGTH_SHORT).show();
                }
                else if(whether == 2){
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("16:30").child("Exist").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (exist.equals("0")) {
                                Toast.makeText(IncheonBackActivity.this, "존재하지 않는 버스입니다.", Toast.LENGTH_SHORT).show();
                            } else {
                                Intent intent = new Intent(IncheonBackActivity.this, ReservationActivity.class);
        ...
        Incheon_back2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(whether == 0){
                    ...
                    for(int i=1; i<=37; i++){
                        String seat = String.valueOf(i);
                        mDatabaseRef.child(Date).child("인천,송내").child("하교").child("18:10").child(seat).setValue(busSeat);
                    }
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                if(whether == 2){
//                    Intent intent1 = new Intent(IncheonBackActivity.this , ReservationSettingActivity.class);
//                    intent.putExtra("userId", Id);
//                    startActivity(intent1);
//                }
//                else if(whether == 1){
//                    Intent intent2 = new Intent(IncheonBackActivity.this , BusSearchActivity.class);
