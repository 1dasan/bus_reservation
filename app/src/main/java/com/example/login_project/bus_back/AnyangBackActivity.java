...
public class AnyangBackActivity extends AppCompatActivity {

    private FirebaseAuth mFirebaseAuth;
    private DatabaseReference mDatabaseRef;
    private Button Anyang_back1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anyang_back);
        ...
        Anyang_back1 = findViewById(R.id.btn_AY_af1);
        back_button = findViewById(R.id.back_button5);

        Anyang_back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (whether == 0) {
                    ...
                    for(int i=1; i<=37; i++){
                        ...
                        mDatabaseRef.child(Date).child("안양").child("하교").child("16:30").child(seat).setValue(busSeat);
                    }
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("16:30").child("Exist").setValue("1");
                    Toast.makeText(AnyangBackActivity.this, "버스추가에 성공했습니다.", Toast.LENGTH_SHORT).show();
                } else if (whether == 1) {
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("16:30").child("Exist").setValue("0");
                    Toast.makeText(AnyangBackActivity.this, "버스삭제에 성공했습니다.", Toast.LENGTH_SHORT).show();
                } else if (whether == 2) {
                    mDatabaseRef.child(Date).child(location).child(go_or_back).child("16:30").child("Exist").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (exist.equals("0")) {
                                Toast.makeText(AnyangBackActivity.this, "존재하지 않는 버스입니다.", Toast.LENGTH_SHORT).show();
                            } else {
                                Intent intent = new Intent(AnyangBackActivity.this, ReservationActivity.class);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                if(whether == 2){
//                    Intent intent1 = new Intent(AnyangBackActivity.this , ReservationSettingActivity.class);
//                    intent.putExtra("userId", Id);
//                    startActivity(intent1);
//                }
//                else if(whether == 1){
//                    Intent intent2 = new Intent(AnyangBackActivity.this , BusSearchActivity.class);
